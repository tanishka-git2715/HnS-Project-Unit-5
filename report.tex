...
\begin{figure}[H]
    ...
    \caption{Visualizing API Health and Churn Metrics in Grafana}
\end{figure}
...
The model achieved an accuracy of \textbf{73.3\%} on the test set.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{mlflow.png}
    \caption{MLflow Tracking Dashboard showing Experiment Metrics}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{Verification}: Verified the entire pipeline logic via 8 automated test cases in a containerized environment (100\% pass rate).
\end{itemize}
